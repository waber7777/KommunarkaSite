    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 mix-blend-difference px-6 py-8 md:px-12 pointer-events-none">
            <div className="flex justify-between items-start">
                <Link href="/" className="group overflow-hidden pointer-events-auto shrink-0 mr-4">
                    ...
                    >
                        <h1 className="inline-flex flex-col font-montserrat uppercase leading-none">
                            <span className="text-[20px] md:text-2xl font-bold tracking-[0.1em] md:tracking-[0.15em] flex items-baseline">
                                <span
                            ...
                            <span className="flex justify-between w-full text-[6px] md:text-[10px] font-mono text-secondary group-hover:text-accent transition-colors duration-500 mt-1">
                ...
                <div className="flex flex-col justify-end items-end gap-y-2 pointer-events-auto text-right">
                    {navLinks.map((link, i) => (
                        <Link
                            key={link.href}
                            href={link.href}
