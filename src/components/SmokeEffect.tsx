...
export default function SmokeEffect() {
  ...
  useEffect(() => {
    ...
    // 1. Unified Auction-Style Orange-Golden Clouds (Identical rendering across all pages)
    const smokePuffCount = isMobile ? 6 : 12;
    
    // Rich Orange & Warm Golden Palette from /auction
    const smokeColors = [
    ...
    const render = () => {
      ...
      // --- PASS 1: Render Auction-Style Vibrant Orange-Golden Clouds ---
